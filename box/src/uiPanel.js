...
const updateMatrixRecursively = (object) => {
 ...
 class UIPanelBlock extends ThreeMeshUI.Block {
     ...
     constructor(width = 512, height = 544, options = {}) {
        ...
        //  {
        //     console.log(key, panelOptions[key]);
        //  }
     ...
     addSubBlock(options = {}) {
         ...
         const newBlock = new UIPanelBlock(488, 512, options);
     ...
     {
        return this.frame.raycast(raycaster, intersects);
     }
 }
     ...
     constructor(onclick, options = {}) {
         ...
         const hoveredStateAttributes = {
             ...
             attributes: {
                 ...
                 fontColor: options.fontHoverColor ?? new THREE.Color(0xff00ff),
                 backgroundOpacity: 1,
             },
         };
